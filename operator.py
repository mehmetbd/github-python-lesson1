...
print("total sold per person",player_per_sold)
#calculator machine gun
months=3
years=10
updating_the_game=months//3
next_movie_release=years%10
print("months for the upddate:",updating_the_game)
print("years for the movie:",next_movie_release)